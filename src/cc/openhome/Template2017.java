 ...
 * @author Justin
 */
public class Template2017 {

    private final String content = fileContent(Paths.get("resources\\Template2017.html"));
    ...
    public Template2017(String docRoot, String codeLang) {
